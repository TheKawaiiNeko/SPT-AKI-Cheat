...
void Cheat::RenderESP()
{
    ...
    for (int i = 0; i < PlayerList.itemCount; i++)
    {
        ...
        if (g.ESP_Box)
        {
            ...
            DrawLine(ImVec2(ScreenPosition.x - (width / 2.f), ScreenPosition.y), ImVec2(ScreenPosition.x - (width / 2.f), ScreenPosTop.y), color, 1.f);
            DrawLine(ImVec2(ScreenPosition.x + (width / 2.f), ScreenPosition.y), ImVec2(ScreenPosition.x + (width / 2.f), ScreenPosTop.y), color, 1.f);

            DrawLine(ImVec2(ScreenPosition.x + (width / 2.f), ScreenPosition.y), ImVec2(ScreenPosition.x - (width / 2.f), ScreenPosition.y), color, 1.f);
            DrawLine(ImVec2(ScreenPosition.x + (width / 2.f), ScreenPosTop.y), ImVec2(ScreenPosition.x - (width / 2.f), ScreenPosTop.y), color, 1.f);
        }
